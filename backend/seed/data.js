...
exports.tourPackages = [
    {
        ...
        locationKey: 'data.tours.goldenTriangle.location',
        deityKey: 'data.tours.goldenTriangle.deity',
        ...
        gallery: [
            ...
            'https://images.unsplash.com/photo-1596401032906-6f731a545a33?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
            'https://images.unsplash.com/photo-1588416936227-437f2d410780?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
        ],
        itinerary: [
            { day: 1, titleKey: 'data.tours.goldenTriangle.itinerary.day1.title', descriptionKey: 'data.tours.goldenTriangle.itinerary.day1.description' },
            { day: 2, titleKey: 'data.tours.goldenTriangle.itinerary.day2.title', descriptionKey: 'data.tours.goldenTriangle.itinerary.day2.description' },
            { day: 3, titleKey: 'data.tours.goldenTriangle.itinerary.day3.title', descriptionKey: 'data.tours.goldenTriangle.itinerary.day3.description' },
        ],
        accommodationKey: 'data.tours.details.accommodation',
        transportKey: 'data.tours.details.transport',
        mealsKey: 'data.tours.details.meals',
        inclusions: ['data.tours.inclusions.ac_hotel', 'data.tours.inclusions.breakfast', 'data.tours.inclusions.private_car', 'data.tours.inclusions.guide'],
        exclusions: ['data.tours.exclusions.entry_fees', 'data.tours.exclusions.lunch_dinner', 'data.tours.exclusions.personal_expenses'],
        cancellationPolicyKey: 'data.tours.details.cancellation_policy',
        bestTimeToVisitKey: 'data.tours.goldenTriangle.bestTime',
    },
    {
        id: 2,
        nameKey: 'data.tours.charDham.name',
        locationKey: 'data.tours.charDham.location',
        deityKey: 'data.tours.charDham.deity',
        ...
        exclusions: [],
        cancellationPolicyKey: 'data.tours.details.cancellation_policy',
        bestTimeToVisitKey: 'data.tours.charDham.bestTime',
    },
];